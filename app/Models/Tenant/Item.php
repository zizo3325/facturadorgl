...
use App\Models\Tenant\Catalogs\TipProdMed;//achonto
use App\Models\Tenant\Catalogs\ClaseMed;//achonto
use Modules\Account\Models\Account;
use Modules\Item\Models\Category;
use Modules\Item\Models\Laboratorio;//achonto
use Modules\Item\Models\Presentacion;//achonto
...
{
    protected $with = ['item_type', 'unit_type', 'currency_type', 'warehouses','item_unit_types', 'tags', 'tipprodmed', 'clasemed'];//achonto
    protected $fillable = [
        'warehouse_id',
        'name',
        'second_name',
        ...
        'unit_type_id',
        'currency_type_id',
        'tipprodmed_id',//achonto
        'clasemed_id',//achonto
        'concentracion',//achonto
        'via',//achonto
        'contraindicaciones',//achonto
        'sale_unit_price',
        'purchase_unit_price',
        'has_isc',
        'system_isc_type_id',
        ...
        'brand_id',
        'category_id',
        'laboratorio_id',//achonto
        'presentacion_id',//achonto
        'lot_code',
        'lots_enabled',
        'active',
        'line',
    ...
    //achonto
    public function getIndicationsAttribute($value)
    {
        return (is_null($value))?null:json_decode($value);
    }

    public function setIndicationsAttribute($value)
    {
        $this->attributes['indications'] = (is_null($value))?null:json_encode($value);
    }
    ...
    public function tipprodmed()//achonto
    {
        return $this->belongsTo(TipProdMed::class, 'tipprodmed_id');
    }

    public function clasemed()//achonto
    {
        return $this->belongsTo(ClaseMed::class, 'clasemed_id');
    }
    ...
    public function laboratorio()//achonto
    {
        return $this->belongsTo(Laboratorio::class);
    }

    public function presentacion()//achonto
    {
