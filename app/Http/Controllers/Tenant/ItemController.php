...
use App\Models\Tenant\Catalogs\Indicacion;//achonto
...
class ItemController extends Controller
{
    ...
    public function tables()
    {
        ...
        $indicaciones = Indicacion::orderByName()->get();//achonto
        ...
        return compact('unit_types', 'currency_types', 'attribute_types', 'indicaciones', 'system_isc_types',
                        'affectation_igv_types','warehouses', 'accounts', 'tags', 'categories', 'brands', 'configuration');
    }

    public function tablesmed()
    {
        $unit_types = UnitType::whereActive()->orderByDescription()->get();
        $currency_types = CurrencyType::whereActive()->orderByDescription()->get();
        $indicaciones = Indicacion::orderByName()->get();//achonto
        $system_isc_types = SystemIscType::whereActive()->orderByDescription()->get();
        $affectation_igv_types = AffectationIgvType::whereActive()->get();
        $tipprodmeds = TipProdMed::whereActive()->orderByDescription()->get();//achonto
        $clasemeds = ClaseMed::whereActive()->orderByDescription()->get();//achonto
        // $warehouse = Warehouse::where('establishment_id', auth()->user()->establishment_id)->first();
        $warehouses = Warehouse::all();
        $accounts = Account::all();
        $tags = Tag::all();
        ...
        return compact('unit_types', 'currency_types', 'indicaciones', 'system_isc_types',
                        'affectation_igv_types','tipprodmeds','clasemeds','warehouses', 'accounts', 'tags', 'categories','laboratorios', 'presentaciones','brands', 'configuration');//achonto
    }
