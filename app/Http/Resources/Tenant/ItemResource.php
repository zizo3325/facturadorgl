...
class ItemResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'tipprodmed_id' => $this->tipprodmed_id,//achonto
            'clasemed_id' => $this->clasemed_id,//achonto
            'concentracion' => $this->concentracion,//achonto
            'via' => $this->via,//achonto
            'contraindicaciones' => $this->contraindicaciones,//achonto
            ...
            'laboratorio_id' => $this->laboratorio_id,//achonto
            'presentacion_id' => $this->presentacion_id,//achonto
            ...
            'indications' => $this->indications ? $this->indications : [],//achonto
