<template>
    <div>
        ...
        <div class="card mb-0">
                    ...
                    <tr slot-scope="{ index, row }" :class="{ disable_color : !row.active}">
                        ...
                        <td class="text-right">
                            <template v-if="typeUser === 'admin'">
                                ...
                                <button type="button" class="btn waves-effect waves-light btn-xs btn-info" @click.prevent="clickMed(row.id)">Medicamento</button>
            ...
            <items-med :showDialog.sync="showDialogMed"
                        :recordId="recordId"></items-med><!--achonto-->
...
<script>
    ...
    import ItemsMed from './med.vue'/*achonto */
    ...
    export default {
        props:['typeUser'],
        mixins: [deletable],
        components: {ItemsForm,ItemsMed, ItemsImport, ItemsExport, ItemsExportWp, ItemsExportBarcode, DataTable, WarehousesDetail, ItemsImportListPrice},/*achonto */
        data() {
            return {
                showDialog: false,
                showDialogMed: false,/*achonto */
        ...
        methods: {
            ...
            clickMed(recordId = null) {/*achonto */
                this.recordId = recordId
                this.showDialogMed = true
            },
            clickImport() {
