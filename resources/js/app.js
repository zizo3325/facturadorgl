...
Vue.component('tenant-laboratorios-index', require('../../modules/Item/Resources/assets/js/views/laboratorios/index.vue'));/*achonto*/ 
Vue.component('tenant-indicaciones-index', require('../../modules/Item/Resources/assets/js/views/indicaciones/index.vue'));/*achonto*/
Vue.component('tenant-presentaciones-index', require('../../modules/Item/Resources/assets/js/views/presentaciones/index.vue'));/*achonto*/
