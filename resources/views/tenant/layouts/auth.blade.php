...
<head>
    ...
    <title>MypeSoft: Plataforma de Gestión Comercial</title>
    ...
    @if (file_exists(public_path('theme/background/Logo-Ventasoft.jpg')))
        <style>
            .app{
                background: url('{{ asset('theme/background/Logo-Ventasoft.jpg') }}') center center / cover;
            }
        </style>
    @else
        <style>
            .app{
                background: url('{{ asset('porto-light/background/Logo-Ventasoft.jpg') }}') center center / cover;
            }
        </style>
    @endif
