                ...
                <ul class="nav nav-main">
                    ...
                    <li class="{{ ($path[0] === 'dashboard')?'nav-active':'' }}">
                        <a class="nav-link" href="{{ route('tenant.dashboard.index') }}">
                            <span class="float-right badge mr-3" style="background-color:#1ABC9C;color:#FFF">Plus!</span>
                    ...
                    <li class="
                        ...
                        {{ ($path[0] === 'laboratorios')?'nav-active nav-expanded':'' }}
                        {{ ($path[0] === 'indicaciones')?'nav-active nav-expanded':'' }}
                        {{ ($path[0] === 'presentaciones')?'nav-active nav-expanded':'' }}
                                ...
                                @if(in_array('catalogs', $vc_module_levels))
                                    ...
                                    <li class="nav-parent
                                        ...
                                        <ul class="nav nav-children">
                                            ...
                                            <li class="{{ ($path[0] === 'laboratorios')?'nav-active':'' }}"><!--achonto-->
                                                <a class="nav-link" href="{{route('tenant.laboratorios.index')}}">
                                                Laboratorios
                                                </a>
                                            </li>
                                            <li class="{{ ($path[0] === 'indicaciones')?'nav-active':'' }}"><!--achonto-->
                                                <a class="nav-link" href="{{route('tenant.indicaciones.index')}}">
                                                Indicaciones Medicamento
                                                </a>
                                            </li>
                                            <li class="{{ ($path[0] === 'presentaciones')?'nav-active':'' }}"><!--achonto-->
                                                <a class="nav-link" href="{{route('tenant.presentaciones.index')}}">
                                                Presentaciones Medicamento
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
