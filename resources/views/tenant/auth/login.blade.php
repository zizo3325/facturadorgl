...
@section('content')
    <section class="body-sign">
        <div class="center-sign">
            <div class="card">
                <div class="card card-header card-primary" style="background:#18171c">
                    <p class="card-title text-center">Acceder al Sistema</p>
                    <h1 class="display-3 position-absolute text-left font-weight-bold" style="left: 90%; margin-top: -35px; color: rgba(255,255,255,.1);"></h1>
                </div>
                <div class="card-body">
